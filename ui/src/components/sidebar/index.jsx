    ...
    >
      <div className={`mx-[32px] mt-[40px] mb-[20px] flex items-center gap-4`}>
        ...
        <div className="flex flex-col">
          ...
          <p className="text-[9px] font-bold tracking-[0.2em] text-gray-400 uppercase mt-0.5">Core Platform</p>
        </div>
      </div>
