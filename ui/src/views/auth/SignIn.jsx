      ...
      <div className="mt-[3vh] w-full max-w-full flex-col items-center lg:pl-16 xl:max-w-[440px]">
        ...
        <div className="mb-10 flex items-center gap-4 transition-all hover:scale-[1.01]">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-[10px] font-bold tracking-[0.25em] text-gray-400 uppercase mt-0.5">By OpenLife</p>
          </div>
        </div>
        ...
        <p className="mb-8 text-sm font-medium text-gray-500 dark:text-gray-400">
          Enter your credentials to launch the console.
        </p>
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest whitespace-nowrap">Or</p>
          <div className="h-px w-full bg-gray-200 dark:bg-navy-700" />
        </div>
